...
And that got me thinking about the programming languages and tools I use, If I am prepared for the word or not.
...
Using Go as a back-end and a simple web front-end with no libraries, I decided to write my own bookmark manager: [rimi](https://git.lucdev.net/luc/rimi)
...
[You can now check out my dotfiles here](https://git.lucdev.net/luc/conf_files)
