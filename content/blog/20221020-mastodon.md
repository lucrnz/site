...
> Update: After reading this article, please consider Misskey instead of Mastodon, it is a newer platform with more features (emoji reactions, for example) and generally more user-friendly. You can check a list of [Misskey instances here](https://join.misskey.page/en-US/instances). Of course, it's all up to you.
...
I hope you can now comprehend what Mastodon is, and if you happen to join, please have fun!

[Following me](https://mas.to/@lucie) is completely optional, but deeply appreciated.
