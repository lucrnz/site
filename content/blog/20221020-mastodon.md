...
> Update: After reading this article, please consider Misskey instead of Mastodon, it is a newer platform with more features (emoji reactions, for example) and generally more user-friendly. You can check a list of [Misskey instances here](https://join.misskey.page/en-US/instances). Of course, it is all up to you.
